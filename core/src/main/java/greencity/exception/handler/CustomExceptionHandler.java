...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(GoogleAuthErrorNotNullException.class)
    public final ResponseEntity<Object> handleGoogleAuthErrorNotNullException(
        GoogleAuthErrorNotNullException exception, WebRequest request) {
        log.error(exception.getMessage());
        ExceptionResponse exceptionResponse = new ExceptionResponse(getErrorAttributes(request));
    ...
    @ExceptionHandler(GoogleAuthMissingCodeException.class)
    public final ResponseEntity<Object> handleGoogleAuthMissingCodeException(
        GoogleAuthMissingCodeException exception, WebRequest request) {
        log.error(exception.getMessage());
        ExceptionResponse exceptionResponse = new ExceptionResponse(getErrorAttributes(request));
    ...
    public final ResponseEntity<Object> handleStateMismatchException(
        StateMismatchException exception, WebRequest request) {
        log.error(exception.getMessage());
        ExceptionResponse exceptionResponse = new ExceptionResponse(getErrorAttributes(request));
    ...
    public final ResponseEntity<Object> handleGoogleTokenExchangeException(
        GoogleTokenExchangeException exception, WebRequest request) {
        log.error(exception.getMessage());
        ExceptionResponse exceptionResponse = new ExceptionResponse(getErrorAttributes(request));
    ...
    public final ResponseEntity<Object> handleGoogleTokenValidationException(
        GoogleTokenValidationException exception, WebRequest request) {
        log.error(exception.getMessage());
        ExceptionResponse exceptionResponse = new ExceptionResponse(getErrorAttributes(request));
    ...
    public final ResponseEntity<Object> handleGoogleEmailNotVerified(GoogleEmailNotVerifiedException exception,
        WebRequest request) {
        log.error(exception.getMessage());
        ExceptionResponse exceptionResponse = new ExceptionResponse(getErrorAttributes(request));
